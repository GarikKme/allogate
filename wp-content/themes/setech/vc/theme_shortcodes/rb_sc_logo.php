<?php 
	...
	$params = rb_ext_merge_arrs( array(
		...
		array(
			array(
				"type"				=> "attach_image",
				"heading"			=> esc_html_x( 'Logotype', 'backend', 'setech' ),
				"param_name"		=> "image",
				"description"		=> esc_html_x( 'If empty, logotype will be taken from customizer.', 'backend', 'setech' ),
			),
			array(
				"type"				=> "checkbox",
				"param_name"		=> "retina",
				"value"				=> array( esc_html_x( 'Retina', 'backend', 'setech' ) => true ),
				"std"				=> "1"
			),
			array(
				"type"				=> "textfield",
				"heading"			=> esc_html_x( 'Width', 'backend', 'setech' ),
				"description"		=> esc_html_x( 'Dimensions override retina settings.', 'backend', 'setech' ),
				"param_name"		=> "width",
			...
			array(
				"type"				=> "textfield",
				"heading"			=> esc_html_x( 'Height', 'backend', 'setech' ),
				"description"		=> esc_html_x( 'Dimensions override retina settings.', 'backend', 'setech' ),
				"param_name"		=> "height",
				"edit_field_class" 	=> "vc_col-xs-6",
				"value"				=> ""
	...
	/* -----> MODULE DECLARATION <----- */
	vc_map( array(
		"name"				=> esc_html_x( 'RB Logotype', 'backend', 'setech' ),
		"base"				=> "rb_sc_logo",
		'category'			=> "By RB",
		"icon"     			=> "rb_icon",		
		"weight"			=> 80,
